 ...
 *******************************************************************************/
package net.jp2p.builder.persistence;
...
public class SimplePersistenceFactory extends AbstractComponentFactory<IManagedPropertyListener<IJp2pProperties, Object>> implements IContextFactory {
	...
	private IComponentFactoryFilter filter = new BuilderEventFilter<>( BuilderEvents.PROPERTY_SOURCE_PREPARED, this );
	...
	public void onNotifyChange(ComponentBuilderEvent event) {
		...
		PersistenceService<String,Object> service = (PersistenceService<String, Object>) super.createComponent();
		if( service == null )
	 ...
	 * @param event
	 */
	protected synchronized void setPersistedProperty( ComponentBuilderEvent event ){
