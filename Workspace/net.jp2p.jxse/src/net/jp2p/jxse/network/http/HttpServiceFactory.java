 ...
 *******************************************************************************/
package net.jp2p.jxse.network.http;
...
public class HttpServiceFactory extends AbstractFilterFactory<Module> {
	...
	@Override
	public
	synchronized IJp2pComponent<Module> createComponent() {
	...
	private static class Filter extends AbstractComponentFilter<Module, IJp2pContainer<Module>>{
		...
		protected boolean checkComponent(
				IComponentFactory<IJp2pContainer<Module>> factory) {
			return factory.createComponent() instanceof IJp2pContainer;
		}
