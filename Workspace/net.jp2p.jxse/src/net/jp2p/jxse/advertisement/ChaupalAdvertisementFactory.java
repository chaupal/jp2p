 ...
 *******************************************************************************/
package net.jp2p.jxse.advertisement;
...
import net.jp2p.jxse.IChaupalComponents.ChaupalComponents;
import net.jp2p.jxse.advertisement.AdvertisementServicePropertySource.AdvertisementServiceProperties;
import net.jp2p.jxse.discovery.ChaupalDiscoveryService;
...
public abstract class ChaupalAdvertisementFactory<M extends Object, U extends Advertisement> extends AbstractJxtaAdvertisementFactory<M,U>{
		...
		IComponentFactoryFilter filter = new AbstractComponentFactoryFilter<U>((IComponentFactory<U>) this){
			...
			public boolean onAccept(ComponentBuilderEvent event) {
				...
				case COMPONENT_CREATED:
					if( ((AbstractComponentFactory<M>) event.getFactory()).createComponent() instanceof ChaupalDiscoveryService){
						service = (ChaupalDiscoveryService) ((AbstractComponentFactory<M>) event.getFactory()).createComponent();
						return true;
					}
					return false;
				default:
	...
	@Override
	protected IJp2pComponent<M> onCreateComponent( IJp2pPropertySource<IJp2pProperties> source) {
		jas = new Jp2pAdvertisementService<U>((IJp2pWritePropertySource<U>) super.getPropertySource(), advertisement, service );
