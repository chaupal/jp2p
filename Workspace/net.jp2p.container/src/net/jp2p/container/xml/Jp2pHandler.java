...
public class Jp2pHandler extends DefaultHandler implements IContextEntities{
	...
	private static Logger logger = Logger.getLogger( Jp2pHandler.class.getName() );

	public Jp2pHandler( String bundle_id, DeveloperModes mode, IContainerBuilder<Object> builder, IJp2pServiceManager manager, Jp2pBundleSequencer<Object> sequencer, Class<?> clss ) {
	...
	public void startElement(String uri, String localName, String qName, 
		...
		if( IJp2pServiceBuilder.Components.isComponent( qName )){
			...
			case SEQUENCER_SERVICE:
				...
				ssf.setSequencer((Jp2pBundleSequencer<Object>) sequencer);
			default:
				break;
			}
		}
	...
	protected IPropertySourceFactory getFactoryFromClass( String componentName, Attributes attributes, IJp2pPropertySource<?> parentSource ){
		...
		try{
			...
			try{
				factoryClass = builder.getClass().getClassLoader().loadClass( className );
			}
