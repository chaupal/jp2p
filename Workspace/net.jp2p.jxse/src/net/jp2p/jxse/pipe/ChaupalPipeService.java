...
import net.jp2p.jxse.advertisement.Jp2pAdvertisementService;
...
public class ChaupalPipeService extends AbstractJp2pServiceNode<PipeService>{
	...
	private IJp2pActivatorService<PipeAdvertisement> adService;
	
	private static IJp2pComponent<PipeService> service;

	
	public ChaupalPipeService( IJp2pWritePropertySource<IJp2pProperties> source, PipeService pipeService, IJp2pActivatorService<PipeAdvertisement> adService ) {
